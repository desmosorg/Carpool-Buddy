...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userRoleSpinner = findViewById(R.id.signUpSpinner);
        setupSpinner();
        uid = "" + uidGenerator;
        uidGenerator++;
    }
    ...
    private void setupSpinner() {
        ...
        ArrayAdapter<String> langArrAdapter = new ArrayAdapter<String>(signingIn.this,
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()) {
                            ...
                            Log.d("SIGN UP", "createUserWithEmail:failure", task.getException());
                            Toast.makeText(signingIn.this,"Sign up failed", Toast.LENGTH_LONG).show();
                            updateUI(null);
                        }
                    }
                });
